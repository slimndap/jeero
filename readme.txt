...
* Re-download images when the source URL changes (even if the ref stays the same), replacing outdated attachments and storing the new source URL.
...
* Introduced two new filters in preparation of an exciting new feature: Automations (1.30.4).
